...
const staticVendors = [
  {
    id: '1', slug: 'the-grand-pavilion', name: 'The Grand Pavilion', category: 'Wedding Hall',
    ...
    badge: 'Top Rated', badge_color: 'bg-sage-600', tags: ['Air Conditioned', '500 Guests', 'Parking'], verified: true,
  ...
  },
  {
    ...
    badge: 'Trending', badge_color: 'bg-cream-600', tags: ['Veg & Non-Veg', 'Live Counters', 'Home Style'], verified: true,
    gallery: [], description: '', capacity: null, experience_years: null, created_at: ''
  },
  {
    id: '3', slug: 'frame-focus-studio', name: 'Frame & Focus Studio', category: 'Photographer',
    rating: 4.9, reviews: 289, location: 'Hauz Khas, Delhi', price_amount: 45000, price_label: 'per day', price_unit: '₹',
    image: 'https://images.pexels.com/photos/1024960/pexels-photo-1024960.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1',
    badge: 'Premium', badge_color: 'bg-dark-800', tags: ['Candid', 'Cinematic Video', 'Drone'], verified: true,
    gallery: [], description: '', capacity: null, experience_years: null, created_at: ''
  },
  {
    id: '4', slug: 'blossom-decor-studio', name: 'Blossom Decor Studio', category: 'Decorator',
    ...
    badge: 'Popular', badge_color: 'bg-cream-600', tags: ['Floral Themes', 'LED Setup', 'Custom Designs'], verified: true,
    gallery: [], description: '', capacity: null, experience_years: null, created_at: ''
  },
  {
    id: '5', slug: 'rhythm-beats-dj', name: 'Rhythm & Beats DJ', category: 'DJ',
    ...
    badge: 'New', badge_color: 'bg-sage-500', tags: ['Bollywood', 'International', 'Live Band'], verified: false,
    gallery: [], description: '', capacity: null, experience_years: null, created_at: ''
  },
  {
    id: '6', slug: 'event-canvas-pro', name: 'Event Canvas Pro', category: 'Anchor',
    ...
    badge: 'Top Rated', badge_color: 'bg-sage-600', tags: ['Full Planning', 'On-site Management', 'Budget Tracking'], verified: true,
    gallery: [], description: '', capacity: null, experience_years: null, created_at: ''
  },
] as Vendor[];
    ...
    <div className={`animate-on-scroll ${inView ? 'in-view' : ''} delay-${(index + 1) * 100}`}>
      <div className="group bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-400 border border-sage-100 card-hover h-full flex flex-col">
        <div className="relative h-52 overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => navigate(`/vendors/${vendor.slug}`)}>
          <img src={vendor.image} alt={vendor.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
