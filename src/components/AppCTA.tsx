            ...
            <div className="relative">
              ...
              <div className="relative w-64 h-[520px] bg-sage-900 rounded-[3rem] border-4 border-sage-800 shadow-[0_40px_100px_rgba(0,0,0,0.5)] overflow-hidden animate-float">
                <div className="absolute inset-0 bg-gradient-to-b from-sage-800 to-sage-950 overflow-hidden">
                  ...
                  {[
                    { title: 'Wedding Venue', price: '₹1.2L', tag: 'Booked', img: 'https://images.pexels.com/photos/1579253/pexels-photo-1579253.jpeg?auto=compress&cs=tinysrgb&w=200' },
                    { title: 'Catering', price: '₹850/plate', tag: 'Confirmed', img: 'https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?auto=compress&cs=tinysrgb&w=200' },
                    { title: 'Photography', price: '₹45K', tag: 'Pending', img: 'https://images.pexels.com/photos/1684187/pexels-photo-1684187.jpeg?auto=compress&cs=tinysrgb&w=200' },
                    ...
                    <div key={title} className="mx-4 mb-2 bg-sage-700/60 rounded-2xl overflow-hidden flex border border-sage-600/50">
                      <div className="w-14 h-14 flex-shrink-0 overflow-hidden"><img src={img} alt="" className="w-full h-full object-cover" /></div>
